...
// compile = g++ -O2 -std=c++17 -static-libgcc -static-libstdc++ -o single_P.exe single_P.cpp
// Run = ./single_P.exe
int main() {
    ...
    for (time=0; time<max_iter; ++time) {
        ...
        // save_rhs_to_csv(theta, nx1, ny1, "results", "theta_half_single"+ std::to_string(time) +".csv", 17);
